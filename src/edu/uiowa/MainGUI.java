...
public class MainGUI extends JFrame implements UserPlotListener{
	...
	public MainGUI( Vector<Surface> surfaces ) {
		setTitle("Audiogram Surface Viewer");
		...
		resetButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				mainPanel.remove(currentMainComponent);
				c.getView().setViewPoint(defaultViewpoint, true);
				mainPanel.add( (Component) c.getCanvas(),BorderLayout.CENTER);
				revalidate();
			}
		});
