...
public class Poly23Mapper  extends Mapper{
	 ...
	 public Poly23Mapper(String coefs)
	 {
		 ...
		 p21 =  Float.parseFloat(parts[6]);
		 p12 =  Float.parseFloat(parts[7]);
		 p03 =  Float.parseFloat(parts[8]);
	 }
	 
	 @Override
	public double f(double x, double y) {
		return 130 - (p00 + p10*x + p01*y + p20*Math.pow(x, 2) + p11*x*y + p02*Math.pow(y,2) + p21*Math.pow(x,2)*y 
